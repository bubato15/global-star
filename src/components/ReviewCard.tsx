...
export const ReviewCard: React.FC<ReviewCardProps> = ({
  ...
  return (
    <div className="flex flex-col items-start self-stretch p-10 my-auto rounded-3xl opacity-90 bg-slate-50 min-w-[240px] w-[555px] max-md:px-5 max-md:max-w-full">
